...
namespace AgenciaFull.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public LoginsController(AgenciaFullContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Login != null ? 
                          ...
                          Problem("Entity set 'AgenciaFullContext.Login'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AgenciaFullContext.Login'  is null.");
            }
            var login = await _context.Login.FindAsync(id);
            if (login != null)
            {
